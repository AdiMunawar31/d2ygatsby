...
function about() {
  return (
    <Layout className="bg-purple-800">
      <main className="font-sans bg-purple-800">
        <header className="shadow border-t-4 border-purple-800 text-white">
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div>
                <a
                  className="flex items-center text-white hover:text-purple-600"
              ...
              <div className="flex items-center -mx-2">
                <a
                  className="flex items-center mx-2 text-white hover:text-purple-600"
                  href="#"
                >
                  <svg
        ...
        <section className="mt-20">
          <div className="max-w-2xl px-6 text-center mx-auto">
            <h2 className="text-3xl font-semibold text-white">
              Hi,{" "}
              <span className="bg-purple-900 text-white rounded px-1">
                I’m Adi Munawar
              </span>{" "}
              . Nice to meet you.
            </h2>
            <p className="text-gray-200 mt-4">
              ...
              cupiditate sequi, culpa autem! Quaerat ex fugit iste suscipit
              reiciendis, accusamus ipsum quae.
            </p>
            <div className="flex items-end justify-center mt-16">
              ...
              >
                <g clipPath="url(#clip0)">
                  ...
                  />
                  <path
                    d="M124.021 155.185V200.741V211.732H128.39V200.741V158.372L124.021 155.185Z"
                    fill="#435363"
                  />
                  <path
        ...
        <section className="pattern py-20">
          <div className="max-w-5xl px-6 mx-auto text-center">
            ...
            <p className="text-gray-400 mt-4">
              ...
              Ultrices ipsum, enim cursus lorem ac. Orci maecenas praesent arcu
              eget orci est orci nullam. Leo purus est pellentesque massa at
              tortor, est. Aliquet pulvinar a mattis sagittis. Suspendisse porta
              id elementum, massa.
            </p>
          </div>
        </section>
        <section className="py-20">
          <div className="max-w-5xl px-6 mx-auto text-center">
            ...
            <div className="flex flex-col items-center justify-center mt-6">
              <a
                className="max-w-2xl w-full block bg-purple-900 shadow-md rounded-md border-t-4 border-purple-600 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                href="#"
              >
              ...
              <a
                className="mt-8 max-w-2xl w-full block bg-purple-900 shadow-md rounded-md border-t-4 border-purple-600 transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                href="#"
              >
                <div className="flex items-center justify-between px-4 py-2">
                  <h3 className="text-lg font-medium text-gray-200">
            ...
            <div className="flex items-center justify-center mt-12">
              <a
                className="flex items-center text-gray-400 hover:underline hover:text-gray-500"
                href="https://github.com/AdiMunawar31"
              >
                <span>View More</span>
                <svg
            ...
            <div className="flex items-center justify-center mt-10">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                <div className="max-w-xs w-full">
                  <div className="flex items-center justify-center h-56 bg-purple-900 border-b-8 border-purple-400 rounded-md overflow-hidden">
                    <img
                      className="object-cover h-40"
                      src="https://adi-munawar.netlify.app/static/media/lara.50c10050.svg"
                      alt=""
                    />
                  </div>
                  <a
                    href="#"
                    className="block bg-purple-700 mt-5 rounded-md overflow-hidden transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110"
                  >
                ...
                <div className="max-w-xs w-full">
                  <div className="flex items-center justify-center h-56 bg-purple-900 border-b-8 border-purple-400 rounded-md overflow-hidden">
                    <img
                      className="object-cover h-40"
                      src="https://adi-munawar.netlify.app/static/media/react.e68b35f4.svg"
                      alt=""
                    />
                  </div>
                  <a
                ...
                <div className="max-w-xs w-full">
                  <div className="flex items-center justify-center h-56 bg-purple-900 border-b-8 border-purple-400 rounded-md overflow-hidden">
                    <img
                      className="object-cover h-40"
                      src="https://adi-munawar.netlify.app/static/media/node.1261604a.svg"
                      alt=""
                    />
                  </div>
                  <a
